...
public class MemberController {
    ...
    public ResponseEntity<Member> createMember(@RequestBody MemberCreateRequest request){
        ...
        return new ResponseEntity<>(createMember, HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> updateMember(@PathVariable Long memberId, @RequestBody MemberUpdateRequest request){
